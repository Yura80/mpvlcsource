...
{
    &CLSID_MPVlcSource,    // Filter CLSID
...
CFactoryTemplate g_Templates[1] = 
{
    { 
      ...
      &CLSID_MPVlcSource,                // CLSID
      CMPVlcSource::CreateInstance,      // Method to create an instance of MyComponent
...
BOOL APIENTRY DllMain(HANDLE hModule, 
                      ...
                      LPVOID lpReserved)
{
	hFilterInstance = (HINSTANCE)(hModule);
